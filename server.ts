        ...
        if (!user || !user.isAdmin) {
          user = {
            ...
            avatarConfig: user?.avatarConfig || {
              ...
              hideFace: false,
              animations: {
                idle: 'https://cdn.glidrovia.com/default_idle.glb',
                walk: 'https://cdn.glidrovia.com/default_walk.glb',
                jump: 'https://cdn.glidrovia.com/default_jump.glb'
              }
            },
  ...
  io.on("connection", (socket) => {
    ...
    socket.on("identify", async (username) => {
      ...
      if (queuePos > 0) {
        ...
        // Don't mark as online yet if in queue - but for this demo we'll let them through after state update
      }
